...
function getLangCode(type, code) {
  const lang = import_country_language.default.getLanguage(code);
  if (type === "iso639-1") {
...
var getISO6391 = function(code) {
  return getLangCode("iso639-1", code);
};
var getISO6392 = function(code) {
...
var deepl = {
  ...
  maxLength: 1500,
  createUrl: function(text, from, to) {
...
var papago = {
  ...
  createUrl: function(text, from, to) {
    ...
    const encodedText = encodeURIComponent(text).replace(/%26/g, "%25amp");
    return `https://papago.naver.com/?sk=${fromCode}&tk=${toCode}&st=${encodedText}`;
  }
};

// src/models/reverso.ts
var reverso = {
  name: "reverso",
...
async function waitContent(page, selector, retry = 3) {
  while (true) {
    if (retry < 0) {
...
var puppeteer = import_puppeteer_extra.default.default;
puppeteer.use((0, import_puppeteer_extra_plugin_stealth.default)());
var providers = {
...
var Tranl = class {
  ...
  async translate({
    ...
    let i = 0, j = 0, processQueueLastIndex = 0, processQueueSize = 0, processQueue = [];
